package com.example.mdjahirulislam.youtubestyletabs.apiclient;
...
public class Event {
    ...
    public Event(String mName,int mMonth, int mDayOfMonth, String mStartTime, String mEndTime, String mColor) {
        this.mName = mName;
        this.mMonth = mMonth;
    ...
    public WeekViewEvent toWeekViewEvent(){
        ...
        startTime.set( Calendar.MONTH, getmMonth());// edit for month indicate

...
public class WeekView extends View {
    ...
    private void calculateHeaderHeight(){
        ...
        if(containsAllDayEvent) {
            ...
            Log.d( "mHeaderHeight ",String.valueOf( mHeaderHeight ) );
        }
    }
    ...
    private void drawHeaderRowAndEvents(Canvas canvas) {
        ...
        Log.d( "check data", String.valueOf( mHeaderColumnWidth )+" ----  mWidthPerDay----- "+mWidthPerDay+"  ");
        ...
        if (mAreDimensionsInvalid) {
            mEffectiveMinHourHeight= Math.max(mMinHourHeight, (int) ((getHeight() - mHeaderHeight - mHeaderRowPadding * 2 - mHeaderMarginBottom) / 24));//zoom out 12/24
        ...
        Log.d( "start pixel- ----- ",String.valueOf( startPixel ) );
        ...
        Log.d( "line count before ---- ", String.valueOf( lineCount ) );
        lineCount = (lineCount) * (mNumberOfVisibleDays+1);
        float[] hourLines = new float[lineCount * 4];

        Log.d( "line count after ---- ", String.valueOf( lineCount ) + hourLines.length +"--- "+hourLines[6]);
        ...
        for (int dayNumber = leftDaysWithGaps + 1;
            ...
            int i = 0;
            for (int hourNumber = 6; hourNumber < 19; hourNumber++) {
...
//                Toast.makeText( mContext, "Not Draw the line at the current time.", Toast.LENGTH_SHORT ).show();
            }
